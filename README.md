...
[tests]: https://img.shields.io/endpoint?logo=node.js&url=https%3A%2F%2Fgist.githubusercontent.com%2Fsergey-s-betke%2Fd70e4de09a490afc9fb7a737363b231a%2Fraw%2Fremark-code-path-adjustment-junit-tests.json
...
````markdown file=test/examples/02/fixtures/subfolder1/included.md
Hello. I am the included. Test for code file path rebasing:
...
````markdown file=test/examples/02/fixtures/output.md
Hello. I am the included. Test for code file path rebasing:
